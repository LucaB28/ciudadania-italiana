...
(function () {
  ...
  function renderProgress() {
    ...
    $("#riepilogo-count").textContent = docs.length
      ...
      : "EXPEDIENTE SIN ABRIR — empezá por el test";
  ...
  function diligenze() {
    ...
    push("Revisar y estampar LISTA", "en tu expediente", docs.filter(x => x.d.status === "traducida" || (x.d.it && x.d.status === "obtenida")));
  ...
  function renderDiligenza() {
    ...
    quadro.append(el("span", "etichetta", "TU PRÓXIMA DILIGENCIA"));
  ...
  function renderDemoAvviso() {
    ...
    box.append(el("p", null, "Así se ve un expediente a medio camino: mirá los sellos, el árbol y la diligencia que el sitio calcula. Cuando quieras, borralo y cargá tu línea real."));
  ...
  function renderPersons(animDocId) {
    ...
    ordered().forEach(p => {
      ...
      quitar.addEventListener("click", () => {
        if (confirm("¿Quitar a esta persona y sus documentos del expediente?")) {
      ...
      p.docs.forEach(d => {
        ...
        borrar.addEventListener("click", () => {
          if (confirm("¿Quitar el documento «" + d.label + "» del expediente?")) {
  ...
  /* ── MOD. A — test de elegibilidad ──
     ...
     en todas, y al final arma el expediente solo para que nadie quede
  ...
  /* el puente entre el test y el expediente: nadie tiene que empezar de cero */
  ...
  function typeProtocol() {
    const target = "PROT. N. " + state.protocol + " — EXPEDIENTE PERSONAL";
